...
To query for the latest hotfixes, you can run `rhino-hotfix` on your system. You can also directly install a hotfix with `rhino-hotfix <hotfix name>`.  You can find the [hotfix developers documentation](https://wiki.rhinolinux.org/dev/hotfix-101) and [Full syntax](https://wiki.rhinolinux.org/user/hotfix) on the Rhino Linux Wiki.
