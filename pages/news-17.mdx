...
date: 2025/01/19
description: It's been a little while since our last snapshot release. We originally intended for a 2024.3 release, but this was delayed into the new year to allow us a bit more time to polish things up. The Rhino has kept on rolling and we are happy to announce the latest disk image release of Rhino Linux. This release comes with a large list of spectacular updates and improvements to the distribution, setting the stage for an amazing year.
